...
export const messages = {
  ...
  shell: {
    ...
    compactNavigation: "تنقل مختصر",
    openNavigation: "فتح كل الوجهات",
  ...
  dashboard: {
    eyebrow: "إدارة مالية خاصة بالعائلة",
    title: "مساحتكم المالية المشتركة.",
    description:
      "تابعا دخل العائلة ومصاريفها وخططها وحساباتها وأهدافها وصافي ثروتها في مساحة خاصة واحدة.",
    ...
    nextDescription:
      "استخدما أدوات الدخل والمصاريف والحسابات والتحويلات والأصول لإبقاء الصورة المالية للعائلة محدثة.",
    ...
    emptyTitle: "مساحتكم المالية جاهزة.",
    emptyDescription:
      "بيانات العائلة خاصة، ولا تُستبدل الأرصدة والمعاملات بمحتوى تجريبي.",
  },
  auth: {
    ...
    backToFoundation: "عرض حالة النظام",
  },
  feedback: {
    ...
    notFoundDescription: "قد يكون العنوان غير صحيح أو ربما تم نقل الصفحة.",
